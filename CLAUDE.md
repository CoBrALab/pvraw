...
This began as a hard fork of the upstream [BrkRaw](https://github.com/BrkRaw/brkraw) 0.3.x/0.4 line and is developed independently of upstream 0.5+. The distribution and the import package are both `pvraw`. Current version: 1.1.0.
